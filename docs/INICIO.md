...
Para verlo, abrir `index.html` desde la carpeta principal. Bulma está descargado en `css/vendor/`, por lo que no hace falta instalar nada ni conectarse a internet. Su licencia está en `docs/licencias/LICENSE-Bulma.txt`.
